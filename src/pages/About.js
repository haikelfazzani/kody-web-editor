...
function About () {
  return (<main>
    ...
    <div className="container text-center py-5">
      ...
      <p className="lead mb-0">Kody is built by <a href="https://github.com/haikelfazzani" target="_blank" rel="noopener noreferrer">Haikel Fazzani</a> on open-source and wouldn’t exist without it.</p>
      ...
      <figure>
        ...
        <figcaption className="blockquote-footer"><cite title="Source Title">Paul Graham</cite></figcaption>
      </figure>
